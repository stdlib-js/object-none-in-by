...
```javascript
noneInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-none-in-by@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/object-none-in-by/tags). For example,

```javascript
noneInBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/object-none-in-by@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var noneInBy = require( 'path/to/vendor/umd/object-none-in-by/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/object-none-in-by@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/object-none-in-by.svg
[npm-url]: https://npmjs.org/package/@stdlib/object-none-in-by

[test-image]: https://github.com/stdlib-js/object-none-in-by/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/object-none-in-by/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/object-none-in-by/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/object-none-in-by?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/object-none-in-by.svg
[dependencies-url]: https://david-dm.org/stdlib-js/object-none-in-by/main
...
[branches-url]: https://github.com/stdlib-js/object-none-in-by/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/object-none-in-by/main/LICENSE

<!-- <related-links> -->

[@stdlib/object/any-in-by]: https://github.com/stdlib-js/object-any-in-by/tree/umd

[@stdlib/object/every-in-by]: https://github.com/stdlib-js/object-every-in-by/tree/umd
